...
export const Icon = ({ name, className, size }) => {
  ...
  switch (name) {
    case 'arrow-up':
      return (
        <Svg className={validClassName} size={size}>
          <path d="M25.905 1.613c-0.149-1.029-1.104-1.742-2.133-1.593l-16.766 2.428c-1.029 0.149-1.742 1.104-1.593 2.133s1.104 1.742 2.133 1.593l14.903-2.159 2.159 14.903c0.149 1.029 1.104 1.742 2.133 1.593s1.742-1.104 1.593-2.133l-2.428-16.766zM5.273 30.154l20.277-27.145-3.016-2.253-20.277 27.145 3.016 2.253z" />
        </Svg>
      );
    ...
    case 'arrow-down':
      return (
        <Svg className={validClassName} size={size}>
          <path d="M4.201 29.5c0.13 1.097 1.124 1.881 2.221 1.751l17.876-2.113c1.097-0.13 1.881-1.124 1.751-2.221s-1.124-1.881-2.221-1.751l-15.889 1.878-1.878-15.889c-0.13-1.097-1.124-1.881-2.221-1.751s-1.881 1.124-1.751 2.221l2.113 17.876zM26.125 0.753l-21.508 27.274 3.141 2.477 21.508-27.274-3.141-2.477z" />
        </Svg>
      );
